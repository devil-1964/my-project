  ...
  return (
    ...
    >
      <div className="left flex-1 flex flex-col items-center justify-center gap-2 text-center px-4 sm:px-6 lg:px-8">
        ...
        <h2 className='font-medium text-sm text-slate-300'>Discover the future of AI with our advanced generative models. Our systems deliver personalized results based on your input, streamlining your creative and operational goals</h2>
        <Link to="/dashboard">
